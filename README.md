...
| [AI-ассистент по строительному контролю](https://github.com/dankar91/Notebooks/blob/main/RAG/RAG_Construction_assistant.ipynb) | RAG |Open AI, PyPDF2, FAISS, SentenceTransformer|
...
📂📊📝 **Реализовать** множество значимых проектов, в том числе разработать множество инструментов для аналитики и отчетности, а также принять участие в создании нормативных документов федерального назначения
